...
import { DelegateMetadata, DelegateMetrics } from "../../../generated/schema";
...
export function handleMetadata(content: Bytes): void {
  ...
  if (value) {
    ...
    (value.get("delegates") as JSONValue).toArray().forEach((delegateData) => {
      ...
      // TODO: Update this to use the new tags
      delegateMetadata.tags = [];

      // TODO: Update the coreUnitMember
      delegateMetadata.coreUnitMember = false;
